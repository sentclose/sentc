...
use crate::core::asym::SecretKey;
use crate::core::sym::aes_gcm::{raw_decrypt as aes_decrypt, raw_encrypt as aes_encrypt, AesKey};
use crate::get_rand;
...
impl Into<crate::core::asym::PublicKey> for EciesPk
{
	fn into(self) -> crate::core::asym::PublicKey
	{
		crate::core::asym::PublicKey::Ecies(self)
	}
}
