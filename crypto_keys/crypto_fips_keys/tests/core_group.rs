...
fn create_dummy_user() -> (impl Pk, LoginDoneOutput<RsaSk, Ed25519FIPSSignK>)
{
	let password = "12345";

	//create a test user
	let register_out = register::<Aes256GcmKey, RsaSk, Ed25519FIPSSignK, PwHasherGetter>(password).unwrap();
