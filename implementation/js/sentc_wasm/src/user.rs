...
*/
#[wasm_bindgen]
pub fn prepare_register(password: &str) -> Result<String, JsValue>
{
	Ok(user::register(password)?)
}
...
*/
#[wasm_bindgen]
pub async fn register(base_url: String, auth_token: String, password: String) -> Result<String, JsValue>
{
	let register_input = user::register(password.as_str())?;
