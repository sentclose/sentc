...
fn wire_mfa_login_impl(
	...
	FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, UserDataExport, _>(
		WrapInfo {
...
fn wire_group_extract_group_data_impl(port_: MessagePort, server_output: impl Wire2Api<String> + UnwindSafe) {
	FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, GroupOutDataLightExport, _>(
		WrapInfo {
...
impl rust2dart::IntoIntoDart<GroupOutDataLightExport> for GroupOutDataLightExport {
	fn into_into_dart(self) -> Self {
		self
	}
}
...
impl rust2dart::IntoIntoDart<UserDataExport> for UserDataExport {
	fn into_into_dart(self) -> Self {
		self
	}
}
