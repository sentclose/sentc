...
#[uniffi::export]
pub fn decode_jwt(jwt: String) -> Result<Claims, SentcError>
{
...
{
	Ok(sentc_crypto::user::prepare_check_user_identifier_available(
		user_identifier,
	)?)
}
...
{
	Ok(sentc_crypto::user::done_check_user_identifier_available(
		server_output,
	)?)
}
...
{
	Ok(sentc_crypto::user::prepare_register_device_start(
		device_identifier,
		password,
	)?)
}
...
#[uniffi::export]
pub fn prepare_register_device(server_output: &str, user_keys: &str, key_count: i32) -> Result<PreRegisterDeviceData, SentcError>
{
...
pub async fn register_device(
	...
	key_count: i32,
	user_keys: &str,
) -> Result<RegisterDeviceData, SentcError>
{
...
{
	Ok(util_req_full::user::device_key_session(base_url, auth_token, jwt, session_id, user_public_key, group_keys).await?)
}
...
#[uniffi::export]
pub fn extract_user_data(data: &str) -> Result<UserData, SentcError>
{
...
#[uniffi::export]
pub fn done_fetch_user_key(private_key: &str, server_output: &str) -> Result<UserKeyData, SentcError>
{
...
#[uniffi::export(async_runtime = "tokio")]
pub async fn refresh_jwt(base_url: String, auth_token: String, jwt: &str, refresh_token: String) -> Result<String, SentcError>
{
	Ok(util_req_full::user::refresh_jwt(base_url, auth_token.as_str(), jwt, refresh_token).await?)
}

#[uniffi::export(async_runtime = "tokio")]
pub async fn init_user(base_url: String, auth_token: &str, jwt: &str, refresh_token: String) -> Result<UserInitServerOutput, SentcError>
{
...
{
	Ok(sentc_crypto::user::create_safety_number(
		verify_key_1,
		user_id_1,
...
#[uniffi::export]
pub fn user_verify_user_public_key(verify_key: &str, public_key: &str) -> Result<bool, SentcError>
{
	Ok(sentc_crypto::user::verify_user_public_key(verify_key, public_key)?)
}
...
pub async fn get_user_devices(
	...
	last_fetched_id: &str,
) -> Result<Vec<UserDeviceList>, SentcError>
{
...
#[uniffi::export(async_runtime = "tokio")]
pub async fn delete_user(base_url: String, auth_token: &str, fresh_jwt: &str) -> Result<(), SentcError>
{
	Ok(util_req_full::user::delete(base_url, auth_token, fresh_jwt).await?)
}

#[uniffi::export(async_runtime = "tokio")]
pub async fn delete_device(base_url: String, auth_token: &str, fresh_jwt: &str, device_id: &str) -> Result<(), SentcError>
{
	Ok(util_req_full::user::delete_device(base_url, auth_token, fresh_jwt, device_id).await?)
}

#[uniffi::export(async_runtime = "tokio")]
pub async fn update_user(base_url: String, auth_token: &str, jwt: &str, user_identifier: String) -> Result<(), SentcError>
{
	Ok(util_req_full::user::update(base_url, auth_token, jwt, user_identifier).await?)
}
...
#[uniffi::export(async_runtime = "tokio")]
pub async fn user_fetch_public_key(base_url: String, auth_token: &str, user_id: &str) -> Result<UserPublicKeyData, SentcError>
{
...
#[uniffi::export(async_runtime = "tokio")]
pub async fn user_fetch_verify_key(base_url: String, auth_token: &str, user_id: &str, verify_key_id: &str) -> Result<String, SentcError>
{
...
#[uniffi::export(async_runtime = "tokio")]
pub async fn user_pre_done_key_rotation(base_url: String, auth_token: &str, jwt: &str) -> Result<Vec<KeyRotationGetOut>, SentcError>
{
...
#[uniffi::export]
pub fn user_get_done_key_rotation_server_input(server_output: &str) -> Result<KeyRotationInput, SentcError>
{
...
#[uniffi::export(async_runtime = "tokio")]
pub async fn register_raw_otp(base_url: String, auth_token: &str, jwt: &str) -> Result<OtpRegister, SentcError>
{
...
#[uniffi::export(async_runtime = "tokio")]
pub async fn register_otp(base_url: String, auth_token: &str, jwt: &str, issuer: &str, audience: &str) -> Result<OtpRegisterUrl, SentcError>
{
...
#[uniffi::export(async_runtime = "tokio")]
pub async fn get_otp_recover_keys(base_url: String, auth_token: &str, jwt: &str) -> Result<OtpRecoveryKeysOutput, SentcError>
{
...
#[uniffi::export(async_runtime = "tokio")]
pub async fn reset_raw_otp(base_url: String, auth_token: &str, jwt: &str) -> Result<OtpRegister, SentcError>
{
...
#[uniffi::export(async_runtime = "tokio")]
pub async fn reset_otp(base_url: String, auth_token: &str, jwt: &str, issuer: &str, audience: &str) -> Result<OtpRegisterUrl, SentcError>
{
...
#[uniffi::export(async_runtime = "tokio")]
pub async fn disable_otp(base_url: String, auth_token: &str, jwt: &str) -> Result<(), SentcError>
{
	Ok(util_req_full::user::disable_otp(base_url, auth_token, jwt).await?)
}
