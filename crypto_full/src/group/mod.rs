...
async fn create_group(
	...
	#[cfg(feature = "rust")] public_key: &sentc_crypto::entities::keys::PublicKey,
...
pub fn create<'a>(
	...
	#[cfg(feature = "rust")] creators_public_key: &'a sentc_crypto::entities::keys::PublicKey,
...
pub async fn create_child_group(
	...
	#[cfg(feature = "rust")] parent_public_key: &sentc_crypto::entities::keys::PublicKey,
	group_as_member: Option<&str>,
) -> Res
{
...
//allowed because of the rust feature needs the ? for converting to err into sdk full err
...
pub fn decrypt_key(
	...
	#[cfg(feature = "rust")] private_key: &sentc_crypto::entities::keys::SecretKey,
) -> KeyRes
{
...
pub async fn invite_user(
	...
	#[cfg(feature = "rust")] group_keys: &[&sentc_crypto::entities::keys::SymmetricKey],
	group_as_member: Option<&str>,
) -> SessionRes
{
...
pub fn invite_user_session<'a>(
	...
	#[cfg(feature = "rust")] group_keys: &'a [&'a sentc_crypto::entities::keys::SymmetricKey],
	group_as_member: Option<&'a str>,
...
pub async fn key_rotation(
	...
	#[cfg(feature = "rust")] pre_group_key: &sentc_crypto::entities::keys::SymmetricKey,
	user_group: bool,
